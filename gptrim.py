...
nltk.data.path.insert(0, os.path.abspath(os.path.join(sys.path[0], "./nltk_data")))
...
def str2bool(v):
    if v.lower() in ('yes', 'true', 't', 'y', '1'):
        ...
        print('Unsupported options encountered.')

if __name__ == '__main__':
    try:
        res = trim(sys.argv[1], stemmer=sys.argv[2],language=sys.argv[3], remove_spaces=str2bool(sys.argv[4]),remove_stopwords=str2bool(sys.argv[5]), remove_punctuation=str2bool(sys.argv[6]))
        print(res)
